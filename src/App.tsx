...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    {activeAudit && <AuditWizard start={activeAudit} onCancel={() => setActiveAudit(null)} onComplete={audit => { const nextDate = new Date(`${audit.nextAuditDate}T12:00:00`).toLocaleDateString('pt-BR'); updateData({ ...data, audits: [...data.audits, audit] }, `Auditoria concluída. Próxima auditoria: ${nextDate}.`); setActiveAudit(null) }} />}
  </div>
}
