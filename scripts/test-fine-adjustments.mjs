...
try {
  ...
  console.log('PASS: home privacy/cards, personal blocks/status, PDF builders, audit fields/navigation/signature, request-to-supply approval, substitute/cancel, survey deadlines; no JS errors.')
} finally {
  await browser.close()
  await server.close()
}
